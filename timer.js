  ...
  function secondsTimer() {
    ...
    if (seconds <= 0) {
      if (minutes <= 0) {
        ...
        document
          .querySelector(".message")
          .classList.add("show-message"); /* to make an element visible */
...
const updateCount = () => {
  ...
  if (count < target) {
    ...
    document.querySelector(".message").textContent =
      "Welldone! You Hit the Max Level of Productivity!";
...
//display - You better not play with buttons! -  if user clicks to another button during the session!
